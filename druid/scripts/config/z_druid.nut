...
addPerk({
    ID = "perk.druid.pack"
    Script = "scripts/skills/perks/perk_druid_pack"
    Name = "Pack"
    Tooltip = "The wild answers louder. Summon " + green("one more") + " beast each battle."
    Icon = "druid/perk_pack.png"
    IconDisabled = "druid/perk_pack_sw.png"
    Row = 3
})
addPerk({
