...
gt.Const.World.Spawn.NobleBoss <- [
	{
		MovementSpeedMult = 1.0,
		VisibilityMult = 1.0,
		VisionMult = 1.0,
...
this.calculateCosts(this.Const.World.Spawn.NobleBoss);
this.calculateCosts(this.Const.World.Spawn.NobleCEO);
