this.artifact_pike <- this.inherit("scripts/items/weapons/artifact/artifact_weapon", {
	...
	function create()
	{
		...
		this.m.ItemType = this.Const.Items.ItemType.Artifact | this.Const.Items.ItemType.Weapon | this.Const.Items.ItemType.MeleeWeapon | this.Const.Items.ItemType.TwoHanded | this.Const.Items.ItemType.Defensive;
