this.artifact_quiver_of_arrows <- this.inherit("scripts/items/ammo/ammo", {
	m = {},
	function create()
	{
		this.m.ID = "ammo.arrows";
		this.m.Name = "Endless Quiver of Arrows";
		this.m.Description = "An endless quiver of arrows, required to use bows of all kinds. Is automatically refilled after each battle if you have enough ammunition.";
