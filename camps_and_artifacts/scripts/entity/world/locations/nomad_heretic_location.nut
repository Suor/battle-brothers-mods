this.nomad_heretic_location <- this.inherit("scripts/entity/world/location", {
	m = {},
	function getDescription()
	{
		return "A heretic sect from the south; having established their own kingdom, it is only a matter of time before they move on the city-states.";
	}

	function create()
	{
		this.location.create();
		this.m.TypeID = "location.nomad_heretic";
		...
		this.setDefenderSpawnList(this.Const.World.Spawn.NomadCEO);
