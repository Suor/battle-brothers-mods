this.noble_tower_location <- this.inherit("scripts/entity/world/location", {
	m = {
	},
	...
	function create()
	{
		...
		this.m.TypeID = "location.noble_tower";
	...
	function onInit()
	{
		...
		body.setBrush("world_stone_watchtower_01");
		local lighting = this.addSprite("lighting");
		lighting.setBrush("world_stone_watchtower_01_light");
